'''
READ ME
1. Combine all training articles into a single pickle file.
2. Run the summarizer from command prompt as textsummary.py <location and name of pickle file> <location and name of article to be summarized>
'''
import glob
import os
import re
